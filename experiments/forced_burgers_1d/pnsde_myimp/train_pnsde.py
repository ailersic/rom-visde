...
from experiments.forced_burgers_1d.visde.def_model import DriftNetNODE, DispNet, EncodeMeanNet, DecodeMeanNet, EncodeVarNet, DecodeVarNet
...
class TestPNSDE(pl.LightningModule):
    ...
    def training_step(self,
        ...
        z_int = sdeint(temp_sde, z_enc_0, t, method="euler", dt=1e-2).squeeze(1)
...
def main(overwrite: bool = False, data_file: str = "data_bcf_100_10_10_param.pkl", dim_z = 3):
    ...
    pnsde_trainer.fit(pnsde_model, train_dataloader, val_dataloader)
