from experiments.flow_control_2d.sindy_2step.train_psindy import main as train_psindy_main
from experiments.flow_control_2d.sindy_2step.postproc_psindy import main as postproc_psindy_main
#from experiments.flow_control_2d.sindy_2step.make_animation import main as make_animation_main
import pathlib
import sys
import time
import json
