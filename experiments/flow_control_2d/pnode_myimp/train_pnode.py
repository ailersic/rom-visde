...
from experiments.flow_control_2d.visde.def_model import DriftNetNODE, EncodeMeanNet, DecodeMeanNet, EncodeVarNet, DecodeVarNet
...
def main(overwrite: bool = False, data_file: str = "data_param.pkl", dim_z = 7):
    n_win = 1
    n_batch = 133
    ...
    pnode_trainer.fit(pnode_model, train_dataloader, val_dataloader)
